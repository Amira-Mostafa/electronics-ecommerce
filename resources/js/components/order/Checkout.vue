                ...
                <div class="mt-5 mb-5">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" class="form-control"
                                :class="[{ 'is-invalid': errorFor('customer.email') }]" name="email"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" class="form-control"
                                :class="[{ 'is-invalid': errorFor('customer.city') }]" name="city"
                        ...
                        <div class="col-md-2 form-group">
                            ...
                            <input type="text" class="form-control"
                                :class="[{ 'is-invalid': errorFor('customer.state') }]" name="state"
                    ...
                    <div class="text-center">
                        <button class="btn btn-md btn-primary ps-5 pe-5 mt-3" @click="processPayment"
...
export default {
    ...
    async mounted() { //takes publish key and returns my stripe info
        this.stripe = await loadStripe("pk_test_51PpRTh05rURGUkAmNQnejxVd75YohhfSApBfepaXxK0Fb4o63nDim1W6Qbn9NlWz6ReZfuwU8IDGnrfGI96wwI8R0076EHqMCZ");
        const elements = this.stripe.elements(); //returning all payments info 
        this.cardElement = elements.create('card', {
            classes: {
                base: 'form-control'
            }  //this function is for returning stripe object with stripe acount info and with it we can access elements 
            //and then we want to create a new elements with class form-controll and then append these info on the empty div with id card-element
    ...
    methods: {
        ...
        async processPayment() {
            ...
            if (error) {
                ...
                console.log('response is close');
                axios.post('/api/checkout', this.customer)
                    ...
                    .catch((error) => {
                        ...
                        if (error.response) {
                            ...
                            console.error('Error Response Data:', error.response.data);   // The data from the server
                            console.error('Error Status:', error.response.status);       // The HTTP status code
                            console.error('Error Headers:', error.response.headers);     // Any headers returned
